...
int Test_validate_username_main(void)
{
  UnityBegin("/home/ltomaszewski/Work_Place/Coursera/Linux_System_Programming_and_Introduction_to_Buildroot/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
