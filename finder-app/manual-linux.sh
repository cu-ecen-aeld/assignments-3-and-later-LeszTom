...
make ARCH=arm64 CROSS_COMPILE=aarch64-none-linux-gnu- busybox
...
TOOLCHAIN_DIR=$(dirname $(dirname $(whereis ${CROSS_COMPILE}gcc | cut -d" " -f2)))
...
cp -r ../examples/autotest-validate/conf ${OUTDIR}/rootfs/home
